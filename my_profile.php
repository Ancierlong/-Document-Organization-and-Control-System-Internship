...
// find the value of $id in sql
  $sql2 = "SELECT `id`, `role`, `username`, `full_name`, `email` FROM `users` WHERE `id` = $userlog";
  ...
  <div class="addemp-container">
    ...
    <form method="post" action="edit_capstone_thesis.php">
		...
		<div style="width:45%; display:inline-block; margin-left:12.5px; margin-right: 12.5px;">
            ...
            <input type="text" id="full_name" name="full_name" value="<?php echo htmlspecialchars($full_name, ENT_QUOTES, 'UTF-8'); ?>" required>
            <br>
