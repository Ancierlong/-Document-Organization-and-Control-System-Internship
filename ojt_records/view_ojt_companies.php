...
<head>
    ...
    <style>
        ...
        /* There are 11 columns: 9 data + Edit + Archive */
        .searchemp-container th:nth-child(1), .searchemp-container td:nth-child(1) { width: 10%; } /* Company Name */
        .searchemp-container th:nth-child(2), .searchemp-container td:nth-child(2) { width: 12%; } /* Company Description */
        .searchemp-container th:nth-child(3), .searchemp-container td:nth-child(3) { width: 8%; } /* Company Website */
        .searchemp-container th:nth-child(4), .searchemp-container td:nth-child(4) { width: 8%; } /* Company Tel No. */
        .searchemp-container th:nth-child(5), .searchemp-container td:nth-child(5) { width: 9%; } /* Company Email */
        .searchemp-container th:nth-child(6), .searchemp-container td:nth-child(6) { width: 10%; } /* Company Address */
        .searchemp-container th:nth-child(7), .searchemp-container td:nth-child(7) { width: 9%; } /* Contact Person */
        .searchemp-container th:nth-child(8), .searchemp-container td:nth-child(8) { width: 9%; } /* Contact Person Email */
        .searchemp-container th:nth-child(9), .searchemp-container td:nth-child(9) { width: 8%; } /* Contact Person Tel No. */
        .searchemp-container th:nth-child(10), .searchemp-container td:nth-child(10) { width: 8%; } /* Edit */
        .searchemp-container th:nth-child(11), .searchemp-container td:nth-child(11) { width: 8%; } /* Archive */
        ...
        /* Column is 11th (Archive) */
        .searchemp-container:not([data-user-role="Admin"]) th:nth-child(11), /* Archive */
        .searchemp-container:not([data-user-role="Admin"]) td:nth-child(11) {
            display: none; /* Hide column 11 */
        }
...
<body>
    <div class="searchemp-container" data-user-role="<?php echo htmlspecialchars($user_role); ?>">
        ...
        <div class="tophead2">
            <h4>CCS-DOCS</h4>
            <h2>Companies / Linkages</h2>
            <h3>Search: <input type="text" class="search" id="search"
                    placeholder="Search by Name or Website..."></h3>
            <div style="width:45%; display:inline-block; margin-left: 12.5px; margin-right: 12.5px;">
             ...
             <div style="width:45%; display:inline-block; margin-left: 12.5px; margin-right: 12.5px;">
                 <a href="view_ojt_records.php" class="button">View OJT Records</a>
             </div>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    <th onclick="sortTable('company_name')">Company Name</th>
                    <th onclick="sortTable('company_description')">Company Description</th>
                    <th onclick="sortTable('company_website')">Company Website</th>
                    <th onclick="sortTable('company_telno')">Company Tel No.</th>
                    <th onclick="sortTable('company_email')">Company Email</th>
                    <th onclick="sortTable('company_address')">Company Address</th>
                    <th onclick="sortTable('contact_person')">Contact Person</th>
                    <th onclick="sortTable('contact_person_email')">Contact Person Email</th>
                    <th onclick="sortTable('contact_person_telno')">Contact Person Tel No.</th>
                    <th>Edit</th>
                    <th>Archive</th>
                </tr>
            </thead>
    ...
    <script>
        ...
        function loadTable() {
            ...
            let url = `retrieve_ojt_companies.php?search=${encodeURIComponent(currentSearchValue)}&sortBy=${encodeURIComponent(currentSortBy)}&sortOrder=${encodeURIComponent(currentSortOrder)}&page=${currentPage}&rowsPerPage=${rowsPerPage}`;
                ...
                if (xhr.status == 200) {
                     ...
                     if (response) {
                        ...
                        console.error("Error: No JSON response received.");
                         // Use max possible colspan for error message (11 columns)
                         document.getElementById("tableData").innerHTML = "<tr><td colspan='11' style='text-align: center;'>Error loading data. Empty response.</td></tr>";
                         document.getElementById("paginationControls").innerHTML = "";
                     }
                } else {
                    console.error("Error loading table:", xhr.status, xhr.statusText);
                    // Use max possible colspan for error message (11 columns)
                    document.getElementById("tableData").innerHTML = `<tr><td colspan='11' style='text-align: center;'>Error loading data: ${xhr.status} ${xhr.statusText}</td></tr>`;
                    document.getElementById("paginationControls").innerHTML = "";
                }
            };
            ...
            xhr.onerror = function () {
                console.error("Network error loading table.");
                 // Use max possible colspan for error message (11 columns)
                document.getElementById("tableData").innerHTML = "<tr><td colspan='11' style='text-align: center;'>Network error loading data.</td></tr>";
                document.getElementById("paginationControls").innerHTML = "";
            };
            xhr.send();
        }
